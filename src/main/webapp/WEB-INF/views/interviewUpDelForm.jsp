          ...
          <table> 
           ...
           <tr>     
            ...
            <tr>     
               ...
               <input type="hidden" name="table" value="interviewboard">
               <input type="hidden" name="p_no" value="${sessionScope.p_no}">
          
			      
              <center>
                 <span style= "cursor:pointer"  onClick="pushboardname('interviewboard','interview')">[목록화면]</span>
                 <input type="button" value="수정" onClick= "checkboardUpForm('interviewboard','interview');">
                 <input type="button" value="삭제" onClick= "checkboardDelForm('interviewboard','interview');">
     	     </center>
      </form>
  </div>
</body>
