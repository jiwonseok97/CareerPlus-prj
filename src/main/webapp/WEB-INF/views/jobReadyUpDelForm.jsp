...
<body>
  ...
  <%@ include file="header.jsp" %>
     ...
     <h1 style="text-align: center;">[취업게시판 수정/삭제 페이지]</h1>
          ...
          <table> 
           ...
           <tr>     
            ...
            <tr>     
              ...
              <center>
                 <span style= "cursor:pointer"  onClick="pushboardname('jobsearchboard','jobReady')">[목록화면]</span>
                 <input type="button" value="수정" onClick= "checkboardUpForm('jobsearchboard','jobReady');">
                 <input type="button" value="삭제" onClick= "checkboardDelForm('jobsearchboard','jobReady');">
     	     </center>
      </form>
  </div>
</body>
