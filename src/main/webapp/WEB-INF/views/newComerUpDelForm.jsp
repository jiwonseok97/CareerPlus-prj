...
<body>
  ...
  <%@ include file="header.jsp" %>
     ...
     <h1 style="text-align: center;">[신입게시판 수정/삭제 페이지]</h1>
           ...
           <tr>     
            ...
            <tr>     
              ...
              <center>
                 ...
                 <input type="button" value="수정" onClick= "checkboardUpForm('newbieboard','newComer');">
                 <input type="button" value="삭제" onClick= "checkboardDelForm('newbieboard','newComer');">
     	     </center>
      </form>
  </div>
</body>
