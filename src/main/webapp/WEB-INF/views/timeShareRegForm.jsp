...
<body>
  ...
  <%@ include file="header.jsp" %>
    ...
    <center>
   <table  id="rwd-table" align="center"border="1"cellpadding="7"style="border-collapse:collapse"><table align="center"border="1"cellpadding="7"style="border-collapse:collapse">
